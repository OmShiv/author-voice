...
`dist/author-voice-gemini.zip` is a convenience bundle of files to paste or attach; it is not an importable Gem manifest. Create and save the Gem through your account UI.
...
A Gem's knowledge files do not install Python or a Google Docs editing API. Use the host's available export/document capabilities, or transfer the revised source into your document workflow.
