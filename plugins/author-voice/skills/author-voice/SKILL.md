---
name: author-voice
description: Draft or revise research papers and book prose in the author's voice while preserving evidence, technical meaning, and document structure. Use for author-voice, manuscript editing, or requests to make scholarly or book writing less formulaic. Not for unrelated coding or ordinary factual answers.
---
...
- [references/paper.md](references/paper.md) for a research paper.
- [references/book.md](references/book.md) for a book or chapter.
- [references/voice-profile.md](references/voice-profile.md) for profile creation or adaptation.
- [references/artifacts.md](references/artifacts.md) for files, Google Docs, PDFs, long documents, or the optional local checker.
- [references/examples.md](references/examples.md) when an ambiguous edit needs examples.

If supporting resources are unavailable, apply the core instructions above and say so only if their absence prevents the requested work. Tool availability and user authorization govern file operations; this skill itself supplies no document connector.
